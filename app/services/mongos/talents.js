...
const createTalents = async (req) => {
  ...
  // apa bila check true / data talents sudah ada maka kita tampilkan error bad request dengan message talents duplikat
  if (check) throw new BadRequest('talents duplikat');
...
const getOneTalents = async (req) => {
  ...
  if (!result)
    throw new NotFound(`Tidak ada talents dengan id :  ${id}`);
...
const updateTalents = async (req) => {
  ...
  if (check) throw new BadRequest('talents nama duplikat');
